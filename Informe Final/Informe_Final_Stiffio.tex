...
\section{Materiales y Métodos}
    ...
    \subsection{Interfaces de usuario}
        ...
        Finalmente, para salir del historial y regresar al menú principal, el usuario debe presionar el botón Volver, ubicado en la esquina superior derecha de la pantalla.
