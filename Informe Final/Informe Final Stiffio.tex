...
\begin{titlepage}
	...
	{\text{Segundo Cuatrimestre 2025}\par}
        \rule{150mm}{0.1mm}\vspace{0.5cm}
    \includegraphics[width=0.4\textwidth]{images/Logo Stiffio.jpg}\par
        {\LARGE\bfseries Evaluación de rigidez arterial mediante medición de velocidad de onda de pulso con fotopletismografía\par}
	\vspace{1cm}
...
\section{Materiales y Métodos}
    \subsection{Hardware}
        ...
        El diseño de la carcasa del dispositivo se realizó utilizando el software de diseño asistido por computadora \textit{SolidWorks}. El modelo tridimensional se muestra en la Figura \ref{fig:Caja Solid}.
        
        \vspace{0.1cm}
        
        El diseño se desarrolló con el objetivo de alojar de manera segura los componentes electrónicos y facilitar la interacción con el usuario. La tapa superior cuenta con una abertura rectangular para la visualización de la pantalla OLED y un pequeño orificio adyacente para el indicador LED de encendido. Además, se incorporó un orificio lateral para el interruptor de encendido y apagado, y dos orificios en el panel trasero destinados a la instalación de los conectores de los sensores.
