...
% ANEXO D =================================================================================================================
\newpage
\section{Estimación de distancia carotido-radial}
\label{anexo:FactorCorreccion}


\begin{table}[!ht]
    \centering
    \caption{Datos antropométricos empleados para calcular el factor de corrección por altura.}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{images/Reporte PDF.png}
\captionsetup{margin=1.5cm, justification=centering}
